...
export const createMetaData = (post, fullPostUrl) => {
  ...
  // Only add image tags if there is a specific url to link
  if (metaImageUrl !== null) {
    ...
    // Let's try out the ES6 spread operator instead of array.concat()
    metaTags = [...metaTags, ...imageTags];
  }
  ...
  if (post.categories) {
    ...
    metaTags = [...metaTags, ...tags, ...keywordsTag];
  }
